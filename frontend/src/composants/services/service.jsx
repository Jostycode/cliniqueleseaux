...
function Service() {
    ...
    return (
        <>
            <div className="serviceprincipal">
                <div className="servicep ">
                    <h2 className="service-title">🥼 Nos services</h2>
                    <div className="row row-cols-1 row-cols-md-3 g-4 pb-5 px-5">
