                        ...
                        <div className="col-md-6">
                            <div className="side-bb py-5 px-3">
                                ...
                                <p className="card-text text1">
                                    ...
                                    l'équipe médicale hautement qualifié disponible 24h/24 ; 7j/7 prête à répondre à vos besoins de santé les plus urgents.

                                </p>

                                <p>
                                    Situé en plein centre ville, elle possède une capacité d’accueil de 34 lits en hospitalisation à temps complet, repartie en chambres communes et individuelles climatisées, avec salle de bain privative, avec televiseur,wifi, refrigirateur, lit de garde malade.
                                </p>
